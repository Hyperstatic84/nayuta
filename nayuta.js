...
const Nayuta = (() => {
  ...
  const MOTS = [
    "abattoir", "abîme", "abysses", "agonie", "anéantissement", "apocalypse",
    "asphyxie", "asticots", "billot", "boucherie", "boyaux", "brasier",
    "bûcher", "cachot", "cadavre", "calcination", "calvaire", "carcasse",
    "carnage", "cataclysme", "catacombes", "cauchemar", "caveau", "cendres",
    "cercueil", "chaînes", "chair", "chaos", "charnier", "charognards",
    "charogne", "châtiment", "contagion", "convulsions", "corbeaux", "cornes",
    "crâne", "crépuscule", "crocs", "crypte", "curée", "damnation",
    "décapitation", "décombres", "décomposition", "décrépitude", "déluge",
    "démence", "démon", "dépouille", "désastre", "désolation", "douleur",
    "écartèlement", "échafaud", "échine", "effondrement", "effroi",
    "égorgement", "empalement", "entrailles", "épidémie", "épitaphe",
    "épouvante", "éventration", "éviscération", "excréments", "extermination",
    "extinction", "famine", "fange", "fantôme", "faucheuse", "fauve",
    "fémurs", "fers", "fléau", "folie", "fosse", "fournaise", "funérailles",
    "fureur", "gangrène", "gémissement", "gibet", "glas", "gouffre", "goule",
    "griffes", "gueule", "guillotine", "hécatombe", "hémorragie", "horreur",
    "hurlement", "hyène", "immolation", "incendie", "jugement", "lamentation",
    "lapidation", "larves", "linceul", "mâchoire", "malédiction", "martyre",
    "massacre", "mausolée", "meurtre", "meute", "miasme", "moelle",
    "moignons", "moisissure", "monstre", "mort", "mouroir", "mutilation",
    "naufrage", "néant", "nécropole", "nécrose", "noyade", "orbites",
    "ossements", "ossuaire", "oubliettes", "peste", "pestilence", "phalanges",
    "plaie", "poison", "potence", "pourriture", "présage", "puanteur", "pus",
    ...
    "supplice", "ténèbres", "terreur", "thrène", "tombe", "tombeau",
    "torture", "tourment", "trépas", "tuerie", "vautour", "venin", "vermine",
  ...
  const LOCUTIONS = [
    ...
    "griffes noires", "grouillement d'asticots", "haleine fétide",
    ...
    "tombe ouverte", "ultime râle", "vautours patients", "veillée mortuaire",
